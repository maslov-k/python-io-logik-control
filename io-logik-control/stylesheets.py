dark_orange_stylesheet = """QToolTip
{
...
QMenuBar::item:pressed
{
    ...
    background-color: QLinearGradient(
                                      x1:0, y1:0, x2:0, y2:1, stop:1 #212121,
...
QScrollBar:horizontal
{
    ...
    height: 7px; margin: 0px 16px 0 16px;
}
...
QMainWindow::separator
{
    background-color: QLinearGradient(x1:0, y1:0, x2:0, y2:1, stop:0 #161616, stop: 0.5 #151515,
                                      stop: 0.6 #212121, stop:1 #343434); color: white;
    padding-left: 4px;
...
{
    spacing: 3px; /* spacing between items in the tool bar */
    background: url(:/images/icons/handle.png);
}
QMenu::separator
{
    height: 2px;
...
QTabBar::tab
{
    ...
    padding-right: 10px;
    padding-top: 3px;
    padding-bottom: 2px; margin-right: -1px;
}
QTabWidget::pane
{
    border: 1px solid #444;
...
{
    image:url(:/images/icons/checkbox.png);
}
